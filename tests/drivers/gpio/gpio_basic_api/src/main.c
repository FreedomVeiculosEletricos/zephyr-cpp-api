...
static void board_setup(void) {
  ...
  IOMUXC_SW_PAD_CTL_PAD_RGMII2_RD2 = IOMUXC_SW_PAD_CTL_PAD_RGMII2_RD2_PUE_MASK |
  ...
  /* Select pull enabled, speed 100 MHz, drive strength 43 ohm */
  IOMUXC_SW_PAD_CTL_PAD_RGMII2_RD3 = IOMUXC_SW_PAD_CTL_PAD_RGMII2_RD3_PUE_MASK |
  ...
  IOMUXC_SetPinConfig(
      ...
      IOMUXC_SW_PAD_CTL_PAD_PKE_MASK | IOMUXC_SW_PAD_CTL_PAD_HYS_MASK |
